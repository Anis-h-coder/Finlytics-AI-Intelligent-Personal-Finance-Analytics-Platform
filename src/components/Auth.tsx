      ...
      <div className="flex-1 flex flex-col justify-start pt-12 sm:pt-16 md:pt-20 lg:pt-24 pb-12 px-4 sm:px-6 lg:px-8 bg-slate-50 relative overflow-y-auto">
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
          ...
          >
            ...
            {/* Quick Guest Sign-In Divider & Button */}
            <div className="mt-6 pt-5 border-t border-slate-200/80 space-y-3">
              <div className="relative flex py-1 items-center">
                <div className="flex-grow border-t border-slate-200"></div>
                <span className="shrink-0 mx-2 text-[10px] text-slate-400 font-bold uppercase tracking-wider">Instant Access</span>
                <div className="flex-grow border-t border-slate-200"></div>
              </div>
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-3 px-4 bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-extrabold rounded-xl shadow-md hover:shadow-emerald-500/20 transition-all cursor-pointer flex items-center justify-center gap-2 disabled:opacity-50"
              >
                <Zap className="h-4 w-4 fill-emerald-100 text-emerald-100 shrink-0" />
                <span>Quick Sign In as Guest (No Registration)</span>
              </button>
              <p className="text-[10px] text-center text-slate-400 font-medium">
                Instantly explores pre-populated demo ledger, AI Copilot & budget tools.
              </p>
            </div>
